...
<head>
	...
	<title>Home - Tiket Soppeng</title>
	...
	<div class="row" id="city">
		<div class="section">
			<div class="col-md-12 text-center">
				<h3 class="font-purple font-bold font-lg">Tujuan Populer</h3>
				<p class="font-medium font-md">Berbagai tujuan menarik yang dapat dikunjungi.</p>
			</div>
			<div class="col-md-8">
	...
	<div class="row bg-img" id="rentyour">
		<div class="section font-white">
			<div class="col-md-9">
				...
				<p class="font-md font-medium">Tiket Soppeng adalah jasa yang menjual tiket pesawat maupun kapal antar propinsi maupun pulau.</p><br>
				<a href="https://api.whatsapp.com/send?phone=0880000000&amp;text=Assalamu%27alaikum, Saya ingin memesan tiket." class="btn btn-lg bg-purple font-bold">CONTACT US</a>
			</div>
		</div>
	</div>
